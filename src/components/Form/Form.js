                        ...
                        <div class="contact_column">
                            ...
                            <div class="contact_details">
                                <div class="details_info_left">
                                    ...
                                    <a class="details_info_phone">Kontakt telefoniczny: +48 518 330 003, +48 662 234 792</a>
                                </div>
                                <div class="details_item">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <a class="details_info_mail">Kontakt mailowy: polskie.domy.development@outlook.com</a>
                                </div>
                                <div class="details_item">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    <a class="details_info_address">Adres biura sprzedaży: Mińsk Mazowiecki, Warszawska 66/7, 05-300</a>
                                </div>
                            </div>
                            </div>
                            {submitting &&
