                    ...
                    >
                        <section className="slide slide_realizacje_1">
                            <div className="slide_content">
                                <a href="/Chorwacja" className="slide_button button-option">Dom w cenie mieszkania</a>
                        ...
                        <section className="slide slide_realizacje_2">
                            <div className="slide_content">
                                <a className="slide_button button-option">Wykonanie Stanu Developerskiego</a>
                                <p className="slide_text">Wykonanie stanu developerskiego domów w prestiżowej dzielniczy Vilea Property Boutique na Ejsmonda w Józefowie pod Warszawą</p>
                            </div>
                        </section>
                        <section className="slide slide_realizacje_3">
                            <div className="slide_content">
                                <a className="slide_button button-option">Wykończenie pod klucz</a>
