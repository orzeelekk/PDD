                ...
                <div className="openingInwestycje_container container">
                        <div className="ChoseOption">
                            <div className="ChoseOption_bottom">
                                <span className="ChoseOption_icon green dziennik" onClick={() => { scrollToSection(dziennikRef); }}>
                                ...
                                <span className="ChoseOption_icon green cena" onClick={() => { scrollToSection(cenaRef); }}>
                                ...
                                <span className="ChoseOption_icon green budownictwo" onClick={() => { scrollToSection(budownictwoRef); }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                                ...
                                <span className="ChoseOption_icon green okolica" onClick={() => { scrollToSection(okolicaRef); }}>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
                                    <path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/>
                                </svg>                            
                                    <h1 className="ChoseOption_Text">Okolica</h1>
                                </span>
                                <span className="ChoseOption_icon green droga" onClick={() => { scrollToSection(drogaRef); }}>
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
