                ...
                <div className="footer_container container">
                    ...
                    <div class="footer_info_left">
                        <div class="footer_item">
                            ...
                            <span class="footer_info_phone">Kontakt telefoniczny: +48 518 330 003, +48 662 234 792</span>
                        </div>
                        <div class="footer_item">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span class="footer_info_mail">Kontakt mailowy: polskie.domy.development@outlook.com</span>
                        </div>
                        <div class="footer_item">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <span class="footer_info_address">Adres biura sprzedaży: Mińsk Mazowiecki, Warszawska 66/7, 05-300</span>
                        </div>
                    </div>
