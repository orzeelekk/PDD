                ...
                <div className="footer_container container">
                    ...
                    <div className="footer_info_left">
                        <div className="footer_item">
                            ...
                            <span className="footer_info_phone">Kontakt telefoniczny: +48 518 330 003, +48 662 234 792</span>
                        </div>
                        <div className="footer_item">
                            <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                            ...
                            <span className="footer_info_mail">Kontakt mailowy: polskie.domy.development@outlook.com</span>
                        </div>
                        <div className="footer_item">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
